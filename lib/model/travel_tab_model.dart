...
class Article {
  ...
  Article.fromJson(Map<String, dynamic> json) {
    ...
    coverGIF = json['coverGIF'] != null ? CoverGIF.fromJson(json['coverGIF']) : null;
...
class Images {
  ...
  Images({imageId, dynamicUrl, originalUrl, width, height, mediaType, lat, lon, isWaterMarked});
...
class Video {
  ...
  Video({videoId, coverImageUrl, videoUrl, mediaType, width, height, durationSeconds});
