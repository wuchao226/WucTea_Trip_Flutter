...
class SalesBox {
  ...
  SalesBox({icon, moreUrl, bigCard1, bigCard2, smallCard1, smallCard2, smallCard3, smallCard4});

  SalesBox.fromJson(Map<String, dynamic> json) {
    icon = json['icon'];
    moreUrl = json['moreUrl'];
    bigCard1 = json['bigCard1'] != null ? CommonModel.fromJson(json['bigCard1']) : null;
    bigCard2 = json['bigCard2'] != null ? CommonModel.fromJson(json['bigCard2']) : null;
    smallCard1 = json['smallCard1'] != null ? CommonModel.fromJson(json['smallCard1']) : null;
    smallCard2 = json['smallCard2'] != null ? CommonModel.fromJson(json['smallCard2']) : null;
    smallCard3 = json['smallCard3'] != null ? CommonModel.fromJson(json['smallCard3']) : null;
    smallCard4 = json['smallCard4'] != null ? CommonModel.fromJson(json['smallCard4']) : null;
  }
